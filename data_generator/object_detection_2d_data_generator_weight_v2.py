                ...
                if not annotations_dirs is None:
                    ...
                    for obj in objects:
                        try:
                            ...
                            w = float(w)
                            h = float(h)
                            x_min, y_min, w, h = pbx.convert_bbox((x_min, y_min, w, h), from_type="yolo", to_type="coco", image_size=(W, H))
                            ...
                            with open("Image_err.txt", 'a') as f:
                                ...
                                f.write(image_id + ' ' + str(xmin) + ' ' + str(ymin) + ' ' + str(xmax) + ' ' + str(ymax))
                                f.write("\n")
                                f.close()
                    self.labels.append(boxes)
                    self.eval_neutral.append(eval_neutr)
                    ...
                    for obj in objects:
                        try:
                            ...
                            if not sample_weights_dirs is None:
                                weightstr = image_id + ' ' + str(xmin) + ' ' + str(ymin) + ' ' + str(xmax) + ' ' + str(ymax) + ',' + str(1)
