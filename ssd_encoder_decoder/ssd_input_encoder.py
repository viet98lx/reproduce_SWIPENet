...
class SSDInputEncoder:
    ...
    def __call__(self, ground_truth_labels, diagnostics=False):
        ...
        # y_encoded = sample_weights 1, classes_tensor 5, boxes_tensor 4, boxes_tensor 4, variances_tensor 4,  all 18
        ...
        for i in range(batch_size): # For each batch item...
            ...
            y_encoded[i, bipartite_matches, 1:-8] = labels_one_hot
            # y_encoded = sample_weights 1, classes_tensor 5, boxes_tensor 4, boxes_tensor 4, variances_tensor 4,  all 18
            ...
            if self.matching_type == 'multi':
                ...
                # Write the ground truth data to the matched anchor boxes.
                y_encoded[i, matches[1], 1:-8] = labels_one_hot[matches[0]]
    ...
    def generate_encoding_template(self, batch_size, diagnostics=False):
        ...
        # sample_weights 1, classes_tensor 5, boxes_tensor 4, boxes_tensor 4, variances_tensor 4,  all 18
        if diagnostics:
